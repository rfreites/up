    ...
    public function getData()
    {
        ...
        if(!is_null($this->getToken())) {
            ...
            if(strlen($this->getCard()->getFirstName()) === 0) {
                throw new \App\Cashier\Omnipay\Common\Exception\InvalidCreditCardException("The First Name parameter is required");
            }

            if(strlen($this->getCard()->getLastName()) === 0) {
                throw new \App\Cashier\Omnipay\Common\Exception\InvalidCreditCardException("The Last Name parameter is required");
            }
