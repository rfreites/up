...
namespace App\Cashier\Omnipay\NetPay;
...
class ApiGateway extends AbstractGateway
{
    ...
    {
        return $this->createRequest('\App\Cashier\Omnipay\NetPay\Message\ApiPurchaseRequest', $parameters);
    }

    public function authorize(array $parameters = array())
    {
        return $this->createRequest('\App\Cashier\Omnipay\NetPay\Message\ApiAuthorizeRequest', $parameters);
    }

    public function capture(array $parameters = array())
    {
        return $this->createRequest('\App\Cashier\Omnipay\NetPay\Message\ApiCaptureRequest', $parameters);
    }

    public function refund(array $parameters = array())
    {
        return $this->createRequest('\App\Cashier\Omnipay\NetPay\Message\ApiRefundRequest', $parameters);
    }

    public function retrieveTransaction(array $parameters = array())
    {
        return $this->createRequest('\App\Cashier\Omnipay\NetPay\Message\ApiRetrieveTransactionRequest', $parameters);
    }

    public function void(array $parameters = array())
    {
        return $this->createRequest('\App\Cashier\Omnipay\NetPay\Message\ApiVoidRequest', $parameters);
    }

    public function createCard(array $parameters = array())
    {
        return $this->createRequest('\App\Cashier\App\Cashier\Omnipay\NetPay\Message\ApiTokenCreateRequest', $parameters);
    }

    public function deleteCard(array $parameters = array())
    {
        return $this->createRequest('\App\Cashier\Omnipay\NetPay\Message\ApiTokenDeleteRequest', $parameters);
    }

    public function retrieveCard(array $parameters = array())
    {
        return $this->createRequest('\App\Cashier\Omnipay\NetPay\Message\ApiTokenRetrieveRequest', $parameters);
    }
}
